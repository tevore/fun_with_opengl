...
int main()
{
    ...
    // fragment shader(s)
    int fragmentShaders[2];
    fragmentShaders[0] = glCreateShader(GL_FRAGMENT_SHADER);
    fragmentShaders[1] = glCreateShader(GL_FRAGMENT_SHADER);

    //Frag Shader 1
    glShaderSource(fragmentShaders[0], 1, &fragmentShaderSourceOrange, NULL);
    ...
    //Frag Shader 2
    glShaderSource(fragmentShaders[1], 1, &fragmentShaderSourceGreen, NULL);
    ...
    glAttachShader(shaderProgram_1, fragmentShaders[0]);
    glAttachShader(shaderProgram_2, vertexShader);
    glAttachShader(shaderProgram_2, fragmentShaders[1]);
    ...
    // ------------------------------------------------------------------
    float triangle1[] = {
        -0.5f, 0.0f, 0.0f, // far-left
         0.0f,  0.5f, 0.0f,  // top-left
         0.0f, 0.0f, 0.0f //intersection point ( right or left ),
    };

    float triangle2[] = {
        0.0f, 0.0f, 0.0f, //intersection point ( right or left ),
         0.5f, 0.0f, 0.0f, // far-right
